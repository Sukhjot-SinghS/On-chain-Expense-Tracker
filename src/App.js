...
function App() {
  ...
  const contractAddress = "0x16a31eF412C1b5Ef7Dc4f53bA4505be8f5009745"; // Paste the address recieved from Remix IDE here
      ...
      <header className="App-header">
        ...
        : !isRegistered ? (
          <div class= "gradient-border-section">
            ...
            <p>Current Connected Wallet Address: {account}</p>
            <p>🫂Total Number Of Registered Users={people.length}</p>
